...
export const translations = {
  ...
  shop_recommend_product: {
    en: "Can't find it? Ask us to stock it",
    mr: "सापडत नाही? आम्हाला ते ठेवण्याची विनंती करा",
  },
  ...
  shop_welcome_to: { en: "Welcome to,", mr: "स्वागत आहे," },
  shop_ai_tagline: {
    en: "India's first AI-based ordering platform, personalized to your buying history.",
    mr: "भारतातील पहिले AI-आधारित ऑर्डरिंग प्लॅटफॉर्म, तुमच्या खरेदी इतिहासानुसार वैयक्तिकृत.",
  },
  shop_install_app: { en: "Install", mr: "इंस्टॉल करा" },
  shop_explore: { en: "Explore", mr: "एक्सप्लोर" },
  shop_browse_nav: { en: "Browse", mr: "यादी" },
  shop_search_nav: { en: "Search", mr: "शोधा" },
  shop_orders_nav: { en: "Orders", mr: "ऑर्डर्स" },
  shop_company: { en: "Company", mr: "कंपनी" },
  shop_all_companies: { en: "All Companies", mr: "सर्व कंपन्या" },
  shop_salt: { en: "Salt", mr: "साल्ट" },
  shop_all_salts: { en: "All Salts", mr: "सर्व साल्ट" },
  ...
  shop_outstanding_weekly_note: {
    en: "This is updated weekly. For your latest outstanding balance, please WhatsApp us.",
    mr: "हे साप्ताहिक अद्ययावत केले जाते. अद्ययावत थकबाकीसाठी कृपया आम्हाला WhatsApp करा.",
  },
